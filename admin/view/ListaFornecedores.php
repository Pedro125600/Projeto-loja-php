...
$sql = 'SELECT id_Fornecedores,nome,  cnpj ,insc_estadual,contato,endereco from fornecedores';
...
<table class="table table-striped">
  ...
  <tbody>
   <?PHP foreach ($linhas as $linha) {
    echo "<tr>";
     echo "<td>". $linha->id_Fornecedores."</td>";
     echo "<td>". $linha->nome."</td>";
     echo "<td>". $linha->cnpj."</td>";
     echo "<td>". $linha->insc_estadual."</td>";
     echo "<td>". $linha->contato."</td>";
     echo "<td>". $linha->endereco."</td>";
     echo "<td>  <a  class='btn btn-sm btn-primary' href='AlterarClientes.php?acao=alterar&id=$linha->id_Fornecedores'>Alterar</a> </td>";
     echo "<td>  <a  class='btn btn-sm btn-danger' href='AlterarClientes.php?acao=deletar&id=$linha->id_Fornecedores'>Deletar</a> </td>";
     echo "</tr>";
    }
     ?>
  </tbody>
