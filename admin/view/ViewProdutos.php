...
<?php
include_once '../controller/DAOProdutos.php';
...
if (isset($_POST['botao'])) {
  ...
  $produtos->setMarca( $Descricao = $_POST['nome']);
  $produtos->setMOdelo($PrecoCompra = $_POST['cpf']);
  $produtos->setano($PrecoVendae = $_POST['telefone']);
  $produtos->setcor($QtdeEstoque = $_POST['email']);

  $DAOprodutos ->Insert($produtos);
...
<h5 class="card-title">Cadastre Produto</h5>

<form method="POST" action=""> 
  <div class="mb-3">
  <div  class="form-text">Descricao Produto</div>
    <input type="text" class="form-control" name="nome">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Preço Compra</div>
  ...
  <div class="mb-3">
    ...
    <div  class="form-text">Preço Venda</div>
    <input type="number" class="form-control" name="telefone">
  </div>
  <div class="mb-3">
   
    
    <div  class="form-text">qnt. Estoque</div>
