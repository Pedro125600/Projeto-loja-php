...
include_once '../model/Colaboradores.php';
...
if (isset($_POST['botao'])) {
  $Colaborador->setNome( $nome = $_POST['nome']);
  $Colaborador->setCpf($cpf = $_POST['cpf']);
  $Colaborador->setTel($telefone = $_POST['telefone']);
  $Colaborador->setEmail($email = $_POST['email']);
  $Colaborador->setDependentesNumero($dependentesNumer = $_POST['endereco']);
 $ColaboradorDAO->Insert($Colaborador);
 header("Location:../view/ListaColaborador.php");
}
...
<h5 class="card-title">Cadastre Colaborador</h5>

<form method="POST" action=""> 
  <div class="mb-3">
    
    <div  class="form-text">Digite o nome do Colaborador</div>
    <input type="text" class="form-control" name="nome">
  </div>
  <div class="mb-3">
   
    <div  class="form-text">Digite o CPF do Colaborador</div>
    <input type="text" class="form-control" name="cpf">
  </div>
  <div class="mb-3">
   
   
    <div  class="form-text">Digite o Telefone do Colaborador.</div>
    <input type="text" class="form-control" name="telefone">
  </div>
  <div class="mb-3">
   
    
    <div  class="form-text">Digite o email do colaborador</div>
