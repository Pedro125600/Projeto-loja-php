...
$sql ='SELECT idClientes,nome,cpf,telefone,email,endereco FROM clientes';
...
<table class="table table-striped">
  ...
  <tbody>
   <?PHP foreach ($linhas as $linha) {
    echo "<tr>";
     echo "<td>". $linha->idClientes."</td>";
     echo "<td>". $linha->nome."</td>";
     echo "<td>". $linha->cpf."</td>";
     echo "<td>". $linha->telefone."</td>";
     echo "<td>". $linha->email."</td>";
     echo "<td>". $linha->endereco."</td>";
     echo "<td>  <a  class='btn btn-sm btn-primary' href='AlterarClientes.php?acao=alterar&id=$linha->idClientes'>Alterar</a> </td>";
     echo "<td>  <a  class='btn btn-sm btn-danger' href='AlterarClientes.php?acao=deletar&id=$linha->idClientes'>Deletar</a> </td>";
     echo "</tr>";
    }
     ?>
  </tbody>
