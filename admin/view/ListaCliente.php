  ...
  <tbody>
   <?PHP foreach ($linhas as $linha) {
    echo "<tr>";
     ...
     echo "<td>  <a  class='btn btn-sm btn-primary' href='AlterarCliente.php?acao=alterar&id=$linha->idClientes'>Alterar</a> </td>";
     echo "<td>  <a  class='btn btn-sm btn-danger' href='AlterarCliente.php?acao=deletar&id=$linha->idClientes'>Deletar</a> </td>";
     echo "</tr>";
    }
     ?>
  </tbody>
