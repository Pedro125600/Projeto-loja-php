...
if (isset($_POST['botao'])) {
  ...
  $Pedidos->setFornecedor($Fornecedor = $_POST['fornecedor']);
  $Pedidos->setProduto($Produto = $_POST['descricao']);
  $Pedidos->setQuantidadeEsto($QuantidadeEstoque = $_POST['QuantEsto']);
  $Pedidos->setData($DataPedido = $_POST['data']);
  $Pedidos->setdependente($DependentesNumero = $_POST['DependNUn']);
  $DAOpedidos->Insert($Pedidos);

 header("Location:../view/ListaPedidos.php");
}
...
<h5 class="card-title">Cadastre o Pedido</h5>

<form method="POST" action=""> 
  <div class="mb-3">
  <div  class="form-text">Digite o nome do Fornecedor</div>
    <input type="text" class="form-control" name="fornecedor">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Digite o Produto</div>
    <input type="text" class="form-control" name="descricao">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Digite a QuantidadeEstoque</div>
    <input type="number" class="form-control" name="QuantEsto">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Digite a Data</div>
    <input type="date" class="form-control" name="email">
  
  </div>
  <div class="mb-3">
  <div class="form-text">Digite o DependentesNumero</div>
    <input type="text" class="form-control" name="DependNUn">
