...
require_once '../controller/DAOColaboradores.php';
$sql ='SELECT idcolaborador,nome,cpf,telefone,email,dependentesNumero FROM colaborador';
  ...
  <tbody>
   <?PHP foreach ($linhas as $linha) {
    echo "<tr>";
     ...
     echo "<td>  <a  class='btn btn-sm btn-primary' href='AlterarClientes.php?acao=alterar&id=$linha->idcolaborador'>Alterar</a> </td>";
     echo "<td>  <a  class='btn btn-sm btn-danger' href='AlterarClientes.php?acao=deletar&id=$linha->idcolaborador'>Deletar</a> </td>";
     echo "</tr>";
    }
     ?>
  </tbody>
