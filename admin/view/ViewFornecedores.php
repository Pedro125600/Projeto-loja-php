...
if (isset($_POST['botao'])) {
  ...
  $Fornecedores->setMarca($nome = $_POST['nome']);
  $Fornecedores->setMOdelo($cnpj = $_POST['cpf']);
  $Fornecedores->setano($Insc_estadual = $_POST['telefone']);
  $Fornecedores->setcor($$contato = $_POST['email']);
  $Fornecedores->setvalor($endereco = $_POST['endereco']);
  $DAOFornecedores->Insert($Fornecedores);
...
<h5 class="card-title">Cadastre o Fornecedor</h5>
...
<form method="POST" action=""> 
  ...
  <div class="mb-3">
  <div  class="form-text">Digite o CNPJ d.</div>
    <input type="text" class="form-control" name="cpf">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Digite o insc_estadual .</div>
    <input type="text" class="form-control" name="telefone">
    
  </div>
  <div class="mb-3">
  <div  class="form-text">Digite o contato .</div>
    <input type="text" class="form-control" name="email">
  
  </div>
  <div class="mb-3">
  <div class="form-text">Digite o Endereco .</div>
